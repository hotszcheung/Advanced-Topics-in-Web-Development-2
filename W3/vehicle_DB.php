...
<form action="vehicle_DB.php" method="get">
	<select name="model">
...
if($model == "Evora S"){
	$result = $conn-> query("SELECT * FROM vehicle WHERE model = 'Evora S'");
	...
	$result = $conn-> query("SELECT * FROM vehicle WHERE model = 'Route 29'");
	...
	$result = $conn-> query("SELECT * FROM vehicle WHERE model = 'LPG Coaster'");
